...
class NdjsonLogger {
    ...
    siteId;
    env;
    constructor(component, siteId, env) {
...
function sanitizeContext(value) {
    ...
    if (typeof value === "string")
        return redactStringPatterns(truncate(value, 500));
    if (typeof value === "number" || typeof value === "boolean" || value === null)
        return value;
    return truncate((0, node_util_1.inspect)(value), 500);
}
...
function redactStringPatterns(s) {

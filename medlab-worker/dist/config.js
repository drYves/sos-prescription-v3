...
function loadConfig() {
    ...
    const workerId = getEnv("WORKER_ID") ?? `${node_os_1.default.hostname()}-${process.pid}`;
    const security = {
    ...
    return {
        ...
        wpBaseUrl,
        jobClaimPath: normalizePath(getEnv("JOB_CLAIM_PATH_TEMPLATE") ?? "/wp-json/sosprescription/v3/worker/jobs/claim", "/wp-json/sosprescription/v3/worker/jobs/claim"),
        jobCallbackPathTemplate: normalizePath(getEnv("JOB_CALLBACK_PATH_TEMPLATE") ?? "/wp-json/sosprescription/v3/worker/jobs/{job_id}/callback", "/wp-json/sosprescription/v3/worker/jobs/{job_id}/callback"),
        pdfRenderPathTemplate: normalizePath(getEnv("PDF_RENDER_PATH_TEMPLATE") ?? "/wp-json/sosprescription/v3/worker/render/rx/{rx_id}", "/wp-json/sosprescription/v3/worker/render/rx/{rx_id}"),
        chromeExecutablePath: getEnv("CHROME_EXECUTABLE_PATH")

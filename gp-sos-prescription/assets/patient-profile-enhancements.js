(function () {
  ...
  function buildProfileMarkup(seed) {
    return '' +
      ...
      '        <div class="sp-field"><label class="sp-field__label" for="sp-profile-medical-notes">Précisions médicales (optionnel)</label><textarea id="sp-profile-medical-notes" name="note" class="sp-textarea" rows="5" placeholder="Allergies, antécédents, contre-indications ou toute information utile au médecin....">' + escapeHtml(seed.note) + '</textarea><p class="sp-field__help">Ces informations sont conservées dans votre profil sécurisé et peuvent préremplir vos prochaines demandes.</p></div>' +
